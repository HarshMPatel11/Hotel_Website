...
export default function PageHero({ eyebrow, title, description, image }: Props) {
  return (
    <section className="relative h-[60vh] min-h-[440px] w-full overflow-hidden">
      ...
      <div className="relative h-full mx-auto max-w-7xl px-6 lg:px-10 flex flex-col items-center lg:items-start justify-end pb-16 pt-32 text-center lg:text-left text-white">
